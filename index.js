...
const uri = "mongodb+srv://social-media:9B24T2sczMbXcKqQ@cluster0.d7ug9.mongodb.net/?retryWrites=true&w=majority";
...
app.get('/', (req,res)=>{
    res.send('social-media server is up and running');
})
